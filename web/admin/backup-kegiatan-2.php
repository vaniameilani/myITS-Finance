...
<html lang="en">
  ...
  <body class="mn-ht-100v d-flex flex-column">
                    ...
                    <table id="example1" class="table table-hover table-borderless" style="width:100%">
                      ...
                      <tbody>
                        <tr class="bd-b">
                          ...
                          <td class="table-its">
                            <p class="mg-b-0">7 Feb 2022 - 17 Jun 2022</p>
                          </td>
                          <td class="table-its">
                          ...
                          <td class="table-its">
                            <span class="badge badge-orange-transparent tx-poppins tx-semibold tx-12 mg-l-5">Revisi</span>
                          </td>
                          <td class="table-its">                            
                            <div class="dropdown">
              ...
              <div class="form-row">
                <div class="col-12">
                  <div class="form-group custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="checkbox-enable-1">
                    <label class="custom-control-label" for="checkbox-enable-1">Kegiatan berlangsung lebih dari 1 hari</label>
                  </div>
                </div>
                <div class="col-12">
                  <p class="tx-13 mg-b-5">Berakhir pada</p>
                </div>
                <div class="col-4">
                  <div class="form-group form-floating">
                    <select class="form-select select-akhir-1" id="buat-tgl-akhir" name="tgl_akhir" aria-label="Floating label select example" disabled required>
                      <option value="" selected>Pilih</option>
                      <option value="0">Tidak ditentukan</option>
                      <option value="1">1</option>
                    </select>
                ...
                <div class="col-4">
                  <div class="form-group form-floating">
                    <select class="form-select select-akhir-1" id="buat-bln-akhir" name="bln_akhir" aria-label="Floating label select example" disabled required>
                      <option value="" selected>Pilih</option>
                      <option value="1">Januari</option>
                    </select>
                ...
                <div class="col-4">
                  <div class="form-group form-floating">
                    <select class="form-select select-akhir-1" id="buat-thn-akhir" name="thn_akhir" aria-label="Floating label select example" disabled required>
                      <option value="" selected>Pilih</option>
                      <option value="2022">2022</option>
                    </select>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <p class="tx-poppins tx-medium">Informasi Acara</p>
              <div class="form-group form-floating">
                <input type="text" class="form-control" id="nama-acara" name="nama" placeholder="Nama Acara" value="Masa Perkuliahan dan Evaluasi" required>
                <label for="nama-acara">Nama Acara</label>
              </div>
              <div class="form-group form-floating">
                <select class="form-select" id="jenis-kalender" name="jenis_kalender" aria-label="Floating label select example" required>
              ...
              <div class="form-row">
                <div class="col-12">
                  <div class="form-group custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="checkbox-enable-2">
                    <label class="custom-control-label" for="checkbox-enable-2">Kegiatan berlangsung lebih dari 1 hari</label>
                  </div>
                </div>
                <div class="col-12">
                  <p class="tx-13 mg-b-5">Berakhir pada</p>
                ...
                <div class="col-4">
                  <div class="form-group form-floating">
                    <select class="form-select select-akhir-2" id="edit-tgl-akhir" name="tgl_akhir" aria-label="Floating label select example" disabled required>
                      <option value="">Pilih</option>
                      <option value="0">Tidak ditentukan</option>
                ...
                <div class="col-4">
                  <div class="form-group form-floating">
                    <select class="form-select select-akhir-2" id="edit-bln-akhir" name="bln_akhir" aria-label="Floating label select example" disabled required>
                      <option value="">Pilih</option>
                ...
                <div class="col-4">
                  <div class="form-group form-floating">
                    <select class="form-select select-akhir-2" id="edit-thn-akhir" name="thn_akhir" aria-label="Floating label select example" disabled required>
                      <option value="">Pilih</option>
                      <option value="2022" selected>2022</option>
                    </select>
    ...
    <script type="text/javascript">
      //Mengaktifkan select option untuk tanggal berakhir kegiatan saat dibuat
        $(function() {
          enable_select_buat();
          $("#checkbox-enable-1").click(enable_select_buat);
        });

        function enable_select_buat() {
          if (this.checked) {
            $("select.select-akhir-1").removeAttr("disabled");
          } else {
            $("select.select-akhir-1").attr("disabled", true);
          }
        }
    </script>
    <script type="text/javascript">
      //Mengaktifkan select option untuk tanggal berakhir kegiatan saat diedit
        $(function() {
          enable_select_edit();
          $("#checkbox-enable-2").click(enable_select_edit);
        });

        function enable_select_edit() {
          if (this.checked) {
            $("select.select-akhir-2").removeAttr("disabled");
          } else {
            $("select.select-akhir-2").attr("disabled", true);
          }
        }
    </script>
