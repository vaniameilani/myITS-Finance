  ...
  <body class="mn-ht-100v d-flex flex-column">
        ...
        <div class="container pd-x-0" id="content">
          ...
          <div class="d-flex align-items-center justify-content-between mg-b-20 mg-sm-b-25 mg-lg-b-25">
            <div class="d-flex align-items-center justify-content-start">
              ...
              <h4 class="tx-poppins tx-medium mg-b-0">Jenis Kegiatan</h4>
            </div>
            <div>
                    ...
                    <table id="example1" class="table table-hover table-borderless" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th class="table-its wd-60p">Jenis Kegiatan</th>
                      ...
                      <tbody>
                        <tr class="bd-b">
                          ...
                          <td class="table-its">
                            <p class="tx-medium mg-b-0">Perkuliahan</p>
                          </td>
                          <td class="table-its">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header bd-0 d-flex align-items-center pd-b-0">
            <h5 class="tx-poppins tx-medium mg-b-0">Tambah Jenis Kegiatan</h5>
          ...
          <form>
            <div class="modal-body">
              <div class="form-group form-floating">
                <input type="text" class="form-control" id="nama-jenis-1" name="nama" placeholder="Nama Jenis Kegiatan" required>
                <label for="nama-jenis-1">Nama Jenis Kegiatan</label>
              </div>
              <div class="form-group form-floating">
    ...
    <div class="modal fade effect-scale" id="jenis-edit" tabindex="-1" role="dialog" aria-labelledby="jenis-edit" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header bd-0 d-flex align-items-center pd-b-0">
            <h5 class="tx-poppins tx-medium mg-b-0">Edit Jenis Kegiatan</h5>
            <button type="button" class="btn btn-icon btn-its-custom-1 tx-poppins tx-medium rounded-its-50p d-flex align-items-center" data-dismiss="modal"><ion-icon name="close" class="mg-y-2 tx-18"></ion-icon></button>
          </div>
          <form>
            <div class="modal-body">
              <div class="form-group form-floating">
                <input type="text" class="form-control" id="nama-jenis-2" name="nama" placeholder="Nama Jenis Kegiatan" value="Perkuliahan" required>
                <label for="nama-jenis-2">Nama Jenis Kegiatan</label>
              </div>
              <div class="form-group form-floating">
    ...
    <div class="modal fade effect-scale" id="jenis-hapus" tabindex="-1" role="dialog" aria-labelledby="jenis-hapus" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body">
            <h5 class="tx-poppins tx-medium">Hapus Jenis Kegiatan</h5>
            <p class="mg-b-0">Apakah Anda yakin ingin menghapus jenis kegiatan ini?</p>
          </div>
          <form>
            <div class="modal-footer">
              <button type="button" class="btn btn-its-custom-1 tx-poppins tx-medium" data-dismiss="modal">Batal</button>
