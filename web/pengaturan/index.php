        ...
        <div class="container pd-x-0" id="content">
          ...
          <div class="d-flex align-items-center justify-content-between mg-b-20 mg-sm-b-25 mg-lg-b-25">
            <div class="d-flex align-items-center justify-content-start">
              ...
              <h4 class="tx-poppins tx-medium mg-b-0">Menu Pengaturan</h4>
            </div>
          </div>
          <!-- Untuk judul halaman. Hanya dipakai jika diperlukan -->
          <div class="col-10 l--10">
            <div class="card bd-0 mg-b-10 mg-md-b-20">
              <div class="card-header bd-0 pd-md-y-10">
                ...
                <input placeholder="Cari Menu Pengaturan" type="text" class="search" id="mySearch" onkeyup="myFunction()" style="font-size:15px">
              </div>
            </div>
          </div>
       ...
       <div class="row">
        <ul id="myMenu" class="list-unstyled">
                  ...
                  <div class="rounded-its-10 hover-its-1">
                    <div class="media align-items-center">
                      <div class="card-header bd-0 pd-md-y-20">
                       <img src="../../assets/img/finance/set-kunci.svg" class="wd-50 mg-r-15" alt="">
                      </div>
                      <div class="card-header bd-0 pd-md-y-20">
          ...
          <div class="media align-items-center">
            <div class="col-6 col-sm-6 col-md-5 col-lg-5 col-xl-5">
              <div class="card bd-0 mg-b-10 mg-md-b-20">
                <li><a href="../pengaturan/pengaturan-kunci-RUP.php" >
                  <div class="rounded-its-10 hover-its-1">
                    <div class="media align-items-center">
                      <div class="card-header bd-0 pd-md-y-20">
                       <img src="../../assets/img/finance/set-kunci.svg" class="wd-50 mg-r-15" alt="">
