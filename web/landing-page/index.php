              ...
              <div>
                <div class="d-flex justify-content-start mg-b-10">
                  <div class="d-flex align-items-center">
                    ...
                    <p class="tx-poppins tx-medium tx-white tx-18 tx-md-22 tx-spacing-2 mg-b-0 mg-l-10">Portal</p>
                  </div>
                </div>
                <h3 class="tx-poppins tx-white tx-32 tx-md-36 tx-xl-40 mg-b-10 mg-lg-b-10">Selamat datang di <br><span class="tx-semibold">myITS Portal</span></h3>
                <h5 class="tx-white mg-b-35 tx-14 tx-md-18">Eksplorasi ITS di sini.</h5>
