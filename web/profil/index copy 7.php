      ...
      <div class="content-body mg-t-60">
        <div class="container pd-x-0" id="content">
          ...
          <div class="row row-xs">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-b-20">
              <div class="card bd-0">
                <div class="card-body card-list">
                  <div class="d-flex justify-content-between align-items-center mg-b-20">
                    ...
                    <a href="#" class="btn btn-icon btn-its-custom-1 rounded-its-50p d-flex align-items-center btn-hover"><ion-icon name="pencil" class="mg-y-2 tx-18"></ion-icon></a>
                  </div>
                  <div class="card-list-item">
                    <p class="tx-12 tx-medium tx-color-03 mg-b-0">Nama Panggilan</p>
                    <p class="mg-b-0">Ghannie Wijaya</p>
                  </div>
                  <div class="card-list-item">
                    <p class="tx-12 tx-medium tx-color-03 mg-b-0">Nama Lengkap</p>
                    <p class="mg-b-0">Ghannie Wijaya</p>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-b-20">
              <div class="card bd-0">
                <div class="card-body card-list">
                  ...
                  <div class="card-list-item">
                    <p class="tx-12 tx-medium tx-color-03 mg-b-0">Tanggal Lahir</p>
                    <p class="mg-b-0">20 Maret 1998</p>
                  </div>
                  <div class="card-list-item">
                    <p class="tx-12 tx-medium tx-color-03 mg-b-0">Jenis Kelamin</p>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-b-20">
              <div class="card bd-0">
                <div class="card-body card-list">
                  ...
                  <div class="card-list-item">
                    <p class="tx-12 tx-medium tx-color-03 mg-b-0">Email Utama</p>
                    <p class="mg-b-0">ganiwijaya@live.com</p>
                  </div>
                  <div class="card-list-item">
                    <p class="tx-12 tx-medium tx-color-03 mg-b-0">Email Cadangan</p>
                    <p class="mg-b-0">Belum ditentukan</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-b-20">
              <div class="card bd-0">
                <div class="card-body card-list">
                  ...
                  <div class="card-list-item">
                    <p class="tx-12 tx-medium tx-color-03 mg-b-0">Nomor Ponsel</p>
                    <p class="mg-b-0">081823456789</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-b-20">
              <div class="card bd-0">
                <div class="card-body card-list">
                  <div class="d-flex justify-content-between align-items-center mg-b-20">
                    <h5 class="tx-poppins tx-medium mg-b-0">Keamanan</h5>
                    <a href="#" class="btn btn-icon btn-its-custom-1 rounded-its-50p d-flex align-items-center btn-hover"><ion-icon name="pencil" class="mg-y-2 tx-18"></ion-icon></a>
                  </div>
                  <div class="card-list-item">
                    <p class="tx-12 tx-medium tx-color-03 mg-b-0">Kata Sandi</p>
                    <p class="mg-b-0">Ganti kata sandi secara berkala</p>
                  </div>
                </div>
              </div>
            </div>
