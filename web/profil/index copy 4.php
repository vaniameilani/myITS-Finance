              ...
              <div class="card bd-0">
                <div class="card-body">
                  ...
                  <div class="row row-xs">
                    ...
                    <div class="col-8 col-md-10 mg-b-10"> 1998/03/20 </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row row-xs">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mg-b-10 mg-md-b-0">
                      <a href="#file-upload" data-toggle="modal" data-animation="effect-scale">
                        <div class="bd pd-15 pd-sm-20 rounded-its-10 d-flex align-items-center justify-content-between">
                          <div class="media d-flex align-items-center justify-content-center">
                            <img src="../../assets/img/photo-profile.svg" class="wd-35 mg-r-20">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="modal-body">
                  <div class="form-group">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="file-photo" accept="image/*" required>
                      <label class="custom-file-label" for="file-photo">Pilih berkas</label>
                    </div>
                  </div>
                </div>
                <div class="modal-footer">
              ...
              <div class="tab-pane fade" id="upload" role="tabpanel" aria-labelledby="upload-tab">
                <div class="modal-body">
                  ...
                  <button type='button' class='btn btn-its tx-poppins tx-medium' onclick='cropping()'>Crop Gambar</button>
                </div>
                <div class="modal-footer">
