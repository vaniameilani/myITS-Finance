        ...
        <div class="container pd-x-0" id="content">
          ...
          <div class="d-flex align-items-center justify-content-between mg-b-20 mg-sm-b-25 mg-lg-b-25">
            <div class="d-flex align-items-center justify-content-start">
              ...
              <h4 class="tx-poppins tx-medium mg-b-0">Nama Anda</h4>
            </div>
            <div>
              ...
              <div class="card bd-0">
                <div class="card-body card-list">
                  <div class="d-flex align-items-center justify-content-between mg-b-15">
                    <h5 class="tx-poppins tx-medium mg-b-0">Edit Nama</h5>
                  ...
                  <div class="card-list-item">
                    <p class="tx-poppins tx-medium tx-color-01 mg-b-0">Gani</p>
                    <p class="tx-13 tx-color-03 mg-b-0">Nama Panggilan</p>
                  </div>
                  <div class="card-list-item">
                    <p class="tx-poppins tx-medium tx-color-01 mg-b-0">Ghannie Wijaya</p>
            ...
            <div class="pos-fixed t-80 r-15" style="width: auto;">
              <div class="toast mg-l-auto" data-autohide="false">
                ...
                <div class="toast-body">
                  ...
                  <p class="mg-b-0">Nama Anda berhasil diubah.</p>
                </div>
              </div>
            </div>
          ...
          <form>
            <div class="modal-body">
              <div class="form-group form-floating">
                <input type="text" class="form-control" id="nama-panggilan" name="nama1" placeholder="Nama panggilan" value="Gani" required>
                <label for="nama-panggilan">Nama Panggilan</label>
              </div>
              <div class="form-group form-floating">
                <input type="text" class="form-control" id="nama-lengkap" name="nama2" placeholder="Nama lengkap" value="Ghannie Wijaya" required>
