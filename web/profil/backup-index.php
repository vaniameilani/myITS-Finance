      ...
      <div class="content-body mg-t-60">
        <div class="container pd-x-0" id="content">
          ...
          <div class="row row-sm">
                  ...
                  <div class="card-body bd-0 pd-t-0">
                    <div class="row row-xs">
                      <div class="col-12 mg-b-20">
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 crop-text-1">Gani</p>
                        <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Nama Panggilan</p>
                      </div>
                      <div class="col-12">
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 crop-text-1">Ghannie Wijaya</p>
              ...
              <a href="edit-kelahiran.php">
                <div class="card card-hover bd-0">
                  <div class="card-header bd-0 pd-y-25 d-flex justify-content-between align-items-center">
                    ...
                    <img src="../../assets/img/calendar-3.svg" class="wd-35 ht-35">
                  </div>
                  <div class="card-body bd-0 pd-t-0">
                    <div class="row row-xs">
                      <div class="col-12 mg-b-20">
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 crop-text-1">20 Maret 1998</p>
                        <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Tanggal Lahir</p>
                      </div>
                      <div class="col-12">
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 crop-text-1">Laki-laki</p>
              ...
              <a href="edit-email.php">
                <div class="card card-hover bd-0">
                  ...
                  <div class="card-body bd-0 pd-t-0">
                    <div class="row row-xs">
                      <div class="col-12 mg-b-20">
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 crop-text-1">ganiwijaya@live.com</p>
                        <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Email Utama</p>
                      </div>
                      <div class="col-12">
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 crop-text-1">Belum ditentukan</p>
              ...
              <a href="edit-ponsel.php">
                <div class="card card-hover bd-0">
                  <div class="card-header bd-0 pd-y-25 d-flex justify-content-between align-items-center">
                    ...
                    <img src="../../assets/img/keypad.svg" class="wd-35 ht-35">
                  </div>
                  <div class="card-body bd-0 pd-t-0">
                    <div class="row row-xs">
                      <div class="col-12">
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 crop-text-1 d-flex align-items-center">081823456789 <span class="badge badge-success-transparent mg-l-5">Diverifikasi</span> </p>
              ...
              <a href="edit-sandi.php">
                <div class="card card-hover bd-0">
                  ...
                  <div class="card-body bd-0 pd-t-0">
                    <div class="row row-xs">
                      <div class="col-12">
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 crop-text-1">Terakhir diubah 01/01/2020</p>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-b-10 mg-md-b-20">
              <a href="../lainnya/pengaturan.php">
                <div class="card card-hover bd-0">
                  <div class="card-header bd-0 pd-y-25 d-flex justify-content-between align-items-center">
                    <div>
                      <h5 class="tx-poppins tx-medium mg-b-0">Pengaturan Web</h5>
                      <p class="tx-13 tx-color-03 mg-b-0">Kelola preferensi web.</p>
                    </div>
                    <img src="../../assets/img/setting.svg" class="wd-35 ht-35">
                  </div>
                  <div class="card-body bd-0 pd-t-0">
                    <div class="row row-xs">
                      <div class="col-12">
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 crop-text-1">Buka pengaturan</p>
                        <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Pengaturan Web</p>
                      </div>
                    </div>
                  </div>
                </div>
