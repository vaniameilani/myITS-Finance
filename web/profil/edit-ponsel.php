        ...
        <div class="container pd-x-0" id="content">
          ...
          <div class="d-flex align-items-center justify-content-between mg-b-20 mg-sm-b-25 mg-lg-b-25">
            <div class="d-flex align-items-center justify-content-start">
              ...
              <h4 class="tx-poppins tx-medium mg-b-0">Nomor Ponsel</h4>
            </div>
            <div>
              ...
              <div class="card bd-0">
                <div class="card-body card-list">
                  <div class="d-flex align-items-center justify-content-between mg-b-15">
                    <h5 class="tx-poppins tx-medium mg-b-0">Edit Nomor Ponsel</h5>
                  ...
                  <div class="card-list-item">
                    <p class="tx-poppins tx-medium tx-color-01 mg-b-0">081823456789</p>
                    <span class="badge badge-success-transparent tx-11">Terverifikasi</span>
                  </div>
                  <div class="card-list-item">
                    <p class="tx-poppins tx-medium tx-color-01 mg-b-0">081823456789  <span class="tx-color-03 tx-12 mg-l-5">&bullet;</span> <a href="#verifikasi-email" class="badge badge-its-link-3 tx-poppins tx-medium tx-14" data-toggle="modal" data-animation="effect-scale"> Verifikasi </a> </p>
                    <span class="badge badge-orange-transparent tx-11">Perlu verifikasi</span>
                  </div>
                  <div class="card-list-item">
                    <p class="tx-13 tx-color-03 mg-b-0">Anda belum menambahkan nomor ponsel</p>
                  </div>
                </div>
              </div>
            </div>
