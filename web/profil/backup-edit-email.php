        ...
        <div class="container pd-x-0" id="content">
          ...
          <div class="d-flex align-items-center justify-content-between mg-b-20 mg-sm-b-25 mg-lg-b-25">
            <div class="d-flex align-items-center justify-content-start">
              ...
              <h4 class="tx-poppins tx-medium mg-b-0">Email Utama</h4>
            </div>
            <div>
                  ...
                  <div class="card-list-item">
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="media d-flex justify-content-center align-items-center">
                        <div class="avatar avatar-lg mg-r-15">
                          <span class="avatar-initial rounded-circle bg-its-icon tx-color-its-3"><ion-icon name="mail" class="tx-26"></ion-icon></span>
                        </div>
