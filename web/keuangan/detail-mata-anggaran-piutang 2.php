                ...
                <div class="card-body card-list">
                  <div class="card-list-item">
                    <div class="d-flex align-items-start justify-content-between">
                      <div>
                        <h5 class="tx-poppins tx-medium">115712113101 - Piutang UKT D3</h5>
                        <!-- <span class="tx-13 tx-color-03">Diterbitkan oleh <span class="tx-medium">adminits</span> pada 15 Desember 2021</span> -->
                      </div>
                    </div>
                  </div>
                  <div class="card-list-item">
                    <p class="tx-poppins tx-medium tx-15">Informasi <span class="tx-color-03 tx-12 mg-l-5">&bullet;</span> <a href="edit-mata-anggaran.php" class="badge badge-its-link-3 tx-poppins tx-medium tx-14" data-animation="effect-scale"> Edit </a></p>
                    <div class="row row-xs">
                      <div class="col-4 col-md-3 tx-13 tx-color-03 mg-b-10"> Induk MA </div>
                      <div class="col-8 col-md-9 mg-b-10"> 1157121131 - Piutang Kegiatan Pendidikan </div>
                      ...
                      <div class="col-8 col-md-9 mg-b-10"> .........424114 - Pendapatan Jasa Pelayanan Pendidikan </div>
                      <div class="col-4 col-md-3 tx-13 tx-color-03 mg-b-10"> Cash Basis Map </div>
                      <div class="col-8 col-md-9 mg-b-10"> 424112411104 Pendapatan UKT D3 </div>
