                  ...
                  <div class="table-responsive pd-b-10">
                    <table id="example1" class="table table-hover table-borderless" style="width:100%">
                      ...
                      <tbody>
                        <tr class="bd-b">
                          <td class="table-its">
                            <p class="tx-semibold mg-b-0" style="color: #1878F2;">1</p>
                          </td>
                          <td class="table-its">
                            <p class="mg-b-0">Aset</p>
                          </td>
                          <td class="table-its">
                            <p class="mg-b-0">-</p>
                          </td>
                      ...
                      <tbody>
                        <tr class="bd-b">
                          ...
                          <td class="table-its">
                            <p class="mg-b-0">Kas di Bendahara Pengeluaran</p>
                          </td>
                          <td class="table-its">
                            <p class="mg-b-0">-</p>
                          </td>
                      ...
                      <tbody>
                        <tr class="bd-b">
                          ...
                          <td class="table-its">
                            <p class="mg-b-0">Kas Bendahara Pengeluaran Dana BPPTNBH	</p>
                          </td>
                          <td class="table-its">
                      ...
                      <tbody>
                        <tr class="bd-b">
                          ...
                          <td class="table-its">
                            <p class="mg-b-0">Surat Berharga</p>
                          </td>
                          <td class="table-its">
                            <p class="mg-b-0">-</p>
                          </td>
