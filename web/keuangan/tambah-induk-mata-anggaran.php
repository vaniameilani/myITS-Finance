        ...
        <div class="container pd-x-0" id="content">
          ...
          <div class="d-flex align-items-center justify-content-between mg-b-20 mg-sm-b-20 mg-lg-b-20">
            <div class="d-flex align-items-center justify-content-start">
              <a href="mata-anggaran.php" class="btn btn-icon btn-its-custom-1 tx-poppins tx-medium rounded-its-50p d-flex align-items-center mg-r-5"><ion-icon name="arrow-back-outline" class="mg-y-2 tx-22"></ion-icon></a>
              <h4 class="tx-poppins tx-medium mg-b-0">Tambah Induk Mata Anggaran</h4>
            </div>
            <div>
                  ...
                  <div class="card-list-item">
                    <form>
                        <!-- <div class="form-group form-floating">
                            <input type="text" class="form-control" id="induk-ma" name="induk" placeholder="Induk MA" style="background-color: #ECEFF3;" value="113311 - Deposito" disabled>
                            <label for="induk-ma">Induk MA</label>
                        </div> -->
                        <div class="form-group">
                            <div class="form-floating pos-relative">
                                <input type="text" class="form-control" id="kode-ma" name="kode" placeholder="Aa" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                                <label for="kode-ma">Kode MA</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-floating pos-relative">
                                <input type="text" class="form-control" id="nama-ma" name="nama" placeholder="Aa" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                        ...
                        <div class="form-group form-floating">
                            ...
                            <label for="jenis-kalender">Kategori MA</label>
                        </div>
                        <div class="form-row">
                            <div class="col-6 form-group">
                                <div class="form-floating pos-relative">
                                    ...
                                    <label for="password-field-2">Kode Kegiatan Output</label>
                                </div>
                            </div>
                            <div class="col-6 form-group">
                                <div class="form-floating pos-relative">
                                    <input type="password" class="form-control" id="password-field-2" name="psw-2" placeholder="Aa" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Harus terdiri dari 8 karakter huruf kecil, huruf besar dan angka." required>
                                    <label for="password-field-2">Kode sub_output.komponen</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group form-floating">
                            ...
                            <label for="jenis-kalender">Kode BLU (RBA)</label>
                        </div>
                        <div class="form-group">
                            <div class="form-floating pos-relative">
                                <input type="text" class="form-control" id="casis-basis" name="casis" placeholder="Aa" required>
                                <label for="password-field-2">Casis Basis Map</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-floating pos-relative">
                                <textarea class="form-control" id="keterangan" name="keterangan" placeholder="Aa" required></textarea>
