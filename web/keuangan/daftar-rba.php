        ...
        <div class="container pd-x-0" id="content">
          ...
          <div class="row row-sm">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mg-b-20 d-flex align-items-center justify-content-start">
              <a href="../keuangan/tambah-rba-1.php" class="btn btn-its-3 tx-poppins tx-medium d-flex justify-content-center mg-r-10" data-animation="effect-scale"><ion-icon name="add-outline" class="mg-y-2 tx-18 mg-r-10"></ion-icon>Tambah RBA</a>
