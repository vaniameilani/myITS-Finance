              ...
              <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5 pd-x-0">
                ...
                <div class="card bd-0 shadow">
                  <div class="card-header bd-0 pd-md-y-20 d-flex justify-content-between align-items-center">
                    <div>
                      <h5 class="tx-poppins tx-medium mg-b-0">Keluar</h5>
                    </div>
                  ...
                  <div class="card-body bd-0 pd-t-0">
                    <div class="pd-y-25 pd-x-10 rounded-its-10 bd mg-b-20">
                      <div class="d-flex justify-content-center mg-b-15">
                        <div class="avatar avatar-lg"><span class="avatar-initial rounded-circle bg-its-icon tx-color-its-3"><ion-icon name="log-out" class="tx-30"></ion-icon></span></div>
                      </div>
                      <p class="text-center mg-b-0">Apakah Anda yakin ingin keluar?</p>
                    </div>
                    <div class="d-flex justify-content-end align-items-center">
                      <a href="../beranda" class="btn btn-its-custom-1 tx-poppins tx-medium mg-r-5">Kembali ke Portal myITS</a>
                      <form>
                        <button type="submit" class="btn btn-its-3 tx-poppins tx-medium">Keluar</button>
                      </form>
                    </div>
                  </div>
                </div>
