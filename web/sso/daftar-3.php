                  ...
                  <div class="card-body bd-0 pd-t-0">
                    <div class="pd-y-25 pd-x-10 rounded-its-10 bd mg-b-20">
                      <div class="d-flex justify-content-center mg-b-15">
                        <div class="avatar avatar-lg"><span class="avatar-initial rounded-circle bg-its-icon tx-color-its-3"><ion-icon name="link" class="tx-30"></ion-icon></span></div>
                      </div>
                      <p class="text-center mg-b-0">Link aktivasi sudah tidak valid, Kirim ulang email verifikasi.</p>
                    </div>
                    <div class="d-flex justify-content-end align-items-center">
                      <form>
                        <button type="submit" class="btn btn-its-3 tx-poppins tx-medium">Kirim Ulang Verifikasi</button>
                      </form>
                    </div>
                  </div>
                </div>
