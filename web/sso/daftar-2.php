                  ...
                  <div class="card-body bd-0 pd-t-0">
                    <div class="pd-y-25 pd-x-10 rounded-its-10 bd mg-b-20">
                      <div class="d-flex justify-content-center mg-b-15">
                        <div class="avatar avatar-lg"><span class="avatar-initial rounded-circle bg-its-icon tx-color-its-3"><ion-icon name="mail-unread" class="tx-30"></ion-icon></span></div>
                      </div>
                      <p class="text-center mg-b-0">Untuk tahap selanjutnya, sebuah tautan telah dikirim ke email Anda.</p>
                    </div>
                  </div>
                </div>
              </div>
