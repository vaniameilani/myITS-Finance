              ...
              <div class="card card-body blur-transparent shadow rounded-its-10 wd-100p">
                ...
                <form action="daftar-2.php">
                  ...
                  <div class="form-row">
                    <div class="col-4">
                      <div class="form-group form-floating">
                        <select name="" class="form-select" id="lahir_tgl" aria-label="Floating label select example" required>
                          <option value="0" selected>Pilih</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
                        </select>
                        <label for="lahir_tgl">Tanggal</label>
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-group form-floating">
                        <select name="" class="form-select" id="lahir_bln" aria-label="Floating label select example" required>
                          <option value="0" selected>Pilih</option>
                          <option value="1">Januari</option>
                          <option value="2">Februari</option>
                          <option value="3">Maret</option>
                        </select>
                        <label for="lahir_bln">Bulan</label>
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-group form-floating">
                        <select name="" class="form-select" id="lahir_thn" aria-label="Floating label select example" required>
                          <option value="0" selected>Pilih</option>
                          <option value="1">2022</option>
                          <option value="2">2021</option>
                          <option value="3">2020</option>
                        </select>
                        <label for="lahir_thn">Tahun</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <hr>
                  <div class="pd-15 bd bg-white rounded-its-5 d-flex justify-content-between align-items-center">
                    <p class="mg-b-0">Daftar melalui sosial media</p>
                    <div>
                      <img src="../../assets/img/logo-google.svg" class="ht-15 ht-md-25 mg-r-15">
                      <img src="../../assets/img/logo-facebook.svg" class="ht-15 ht-md-25 mg-r-15">
                      <img src="../../assets/img/logo-apple.svg" class="ht-15 ht-md-25">
                    </div>
                  </div>
                </form>
              </div>
