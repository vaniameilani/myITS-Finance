              ...
              <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5 pd-x-0">
                ...
                <div class="card bd-0 shadow">
                  <div class="card-header bd-0 pd-md-y-20 d-flex justify-content-between align-items-center">
                    <div>
                      <h5 class="tx-poppins tx-medium mg-b-0">Masukkan Kode</h5>
                    </div>
                  ...
                  <div class="card-body bd-0 pd-t-0">
                    <form action="lupa-2.php">
                      <div class="form-group form-floating">
                        <input type="text" class="form-control" id="myits-id" name="nama" placeholder="Kode" required>
                        <label for="myits-id">Kode</label>
                      </div>
                      <div class="d-flex justify-content-end align-items-center">
                        <a type="button" href="lupa-5.php" class="btn btn-its-custom-1 tx-poppins tx-medium mg-r-5">Kembali</a>
            ...
            <div class="pos-fixed t-40 r-15 z-index-10" style="width: auto;">
              <div class="toast mg-l-auto" data-autohide="false">
                ...
                <div class="toast-body">
                  ...
                  <p class="tx-medium mg-b-0">Kode Salah</p>
                  <p class="mg-b-0">Kode yang Anda masukkan tidak sesuai.</p>
                </div>
              </div>
            </div>
