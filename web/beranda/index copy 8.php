        ...
        <div class="container pd-x-0" id="content">
          <div class="row row-sm">
            <div class="col-12 mg-b-20 mg-sm-b-20 mg-lg-b-30">
              <div class="card bd-0 pos-relative" style="background-image: url(../../assets/img/cover-beranda.svg); background-position: right center; background-size:cover;">
                <div class="card-body ht-350">
                  <div class="pd-10 pd-md-20 mg-t-50 mg-sm-t-0">
                    ...
                    <p class="tx-poppins tx-regular tx-white tx-20 tx-md-24 mg-b-0">Selamat datang, Ghannie</p>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 mg-b-10 mg-md-b-20">
              <div class="card bd-0 ht-100p">
                <div class="card-body pd-10">
                  <div class="pd-10 d-flex justify-content-start align-items-center">
                    <img src="../../assets/img/app.svg" class="wd-20 mg-r-15">
                  ...
                  <div class="row row-xs">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 mg-b-10">
                      <a href="https://google.com" target="_blank">
                        <div class="pd-15 rounded-its-10 hover-its-1">
                          <div class="media d-flex align-items-center">
                            ...
                            <div class="media-body crop-text-1">
                              ...
                              <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Sistem informasi akademik untuk memantau IPK</p>
                            </div>
                          </div>
                        </div>
                      </a>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-b-10 mg-md-b-20">
              <div class="card bd-0 ht-100p">
                <div class="card-body pd-10">
                  <div class="pd-10 d-flex justify-content-start align-items-center">
                    <img src="../../assets/img/calendar.svg" class="wd-20 mg-r-15">
                    <h5 class="tx-poppins tx-medium mg-b-0">Kalender</h5>
                  </div>
                  <div class="row row-xs pd-10">
                    <div class="col-5 col-sm-5 col-md-5 col-lg-5 col-xl-5">
                      <div class="pd-15 rounded-its-10 text-center" style="background-color: #26B4FF; background-image: linear-gradient(to bottom right, #26B4FF, #108EE8);">
                        <h5 class="tx-poppins tx-white mg-b-0">Kamis</h5>
                        <h1 class="tx-poppins tx-white tx-70 mg-b-0">6</h1>
                        <p class="tx-poppins tx-medium tx-15 tx-white mg-b-0">Januari</p>
                        <p class="tx-poppins tx-white mg-b-0">2022</p>
                      </div>
                    </div>
                    <div class="col-7 col-sm-7 col-md-7 col-lg-7 col-xl-7 card-list">
                      <div class="card-list-calendar mg-l-5">
                        <p class="tx-poppins tx-medium mg-b-0">Bakar-bakar</p>
                        <p class="tx-13 tx-color-03 mg-b-0">Teknik Informatika</p>
                      </div>
                      <div class="card-list-calendar mg-l-5">
                        <p class="tx-poppins tx-medium mg-b-0">Pengisian IPD</p>
                        <p class="tx-13 tx-color-03 mg-b-0">Kalender Akademik</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 mg-b-10 mg-md-b-20">
              <div class="card bd-0">
                <div class="card-body pd-10">
                  <div class="pd-10 d-flex justify-content-start align-items-center">
                    <img src="../../assets/img/events.svg" class="wd-20 mg-r-15">
                    <h5 class="tx-poppins tx-medium mg-b-0">Agenda</h5>
                  </div>
                  <div class="row row-xs pd-5">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 mg-b-10">
                      <a href="#">
                        <div class="rounded-its-10 hover-its-1 pd-5">
                          ...
                          <div class="pd-15">
                            <span class="badge badge-its-3-transparent tx-12 mg-b-5">Sabtu, 5 Februari 2022</span>
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-5 crop-text-2">Program Beasiswa : Yayasan Tunas Unggul Bangsa (YTUB)</p>
                            <div class="d-flex justify-content-start align-items-center mg-b-3">
                              <ion-icon name="time-outline" class="tx-18 tx-color-03 mg-r-5"></ion-icon>
                              <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">00.00 - 00.00</p>
                            </div>
                            <div class="d-flex justify-content-start align-items-center">
                              <ion-icon name="location-outline" class="tx-18 tx-color-03 mg-r-5"></ion-icon>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 mg-b-10">
                      <a href="#">
                        <div class="rounded-its-10 hover-its-1 pd-5">
                          ...
                          <div class="pd-15">
                            <span class="badge badge-its-3-transparent tx-12 mg-b-5">Sabtu, 5 Februari 2022</span>
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-5 crop-text-2">MOTIP 04 : Konferensi Internasional ke-4 tentang Manajemen Teknologi, Inovasi dan Proyek</p>
                            <div class="d-flex justify-content-start align-items-center mg-b-3">
                              <ion-icon name="time-outline" class="tx-18 tx-color-03 mg-r-5"></ion-icon>
                              <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">00.00 - 00.00</p>
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 mg-b-10">
                      <a href="#">
                        <div class="rounded-its-10 hover-its-1 pd-5">
                          ...
                          <div class="pd-15">
                            <span class="badge badge-its-3-transparent tx-12 mg-b-5">Selasa, 21 Desember 2021</span>
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-5 crop-text-2">Departemen Manajemen Bisnis : Konferensi Internasional ke-3 tentang Bisnis dan Teknik Manajemen</p>
                            <div class="d-flex justify-content-start align-items-center mg-b-3">
                              <ion-icon name="time-outline" class="tx-18 tx-color-03 mg-r-5"></ion-icon>
                              <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">00.00 - 00.00</p>
                            </div>
                    ...
                    <div class="col-12">
                      <a href="index-app.php" role="button" class="btn btn-its-custom-1 tx-poppins tx-medium btn-block">Lihat Semua Agenda</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body pd-10">
                  ...
                  <div class="row row-xs">
                    <div class="col-12 mg-b-5">
                      <a href="#">
                        <div class="pd-y-10 pd-x-5 rounded-its-10 hover-its-1 pd-10">
                    ...
                    <div class="col-12">
                      <a href="index-app.php" role="button" class="btn btn-its-custom-1 tx-poppins tx-medium btn-block">Lihat Semua Pengumuman</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content tabs-animated">
          ...
          <div class="modal-body pd-0">
            <div id="scroll1" class="scrollbar-lg ht-450 pd-15">
              <div class="row row-xs">
                <div class="col-12">
          ...
          <form>
            <div class="modal-body pd-0">
              <div id="scroll1" class="scrollbar-lg ht-450 pd-15">
                ...
                <p class="tx-poppins tx-medium tx-15">Pilih Aplikasi</p>
                <div class="checkbox-its">
                  <div class="label-its mg-b-10 target2">
                    ...
                    <label for="checkboxOne">
                      ...
                      <p class="tx-poppins tx-medium mg-b-0">E-Aset</p>
                    </label>
                  </div>
                  <div class="label-its mg-b-10 target2">
                    ...
                    <label for="checkboxTwo">
                      ...
                      <p class="tx-poppins tx-medium mg-b-0">Manajemen SK</p>
                    </label>
                  </div>
                  <div class="label-its mg-b-10 target2">
                    ...
                    <label for="checkboxThree">
                      ...
                      <p class="tx-poppins tx-medium mg-b-0">IP</p>
                    </label>
                  </div>
                </div>
              </div>
