        ...
        <div class="container pd-x-0" id="content">
          <div class="row row-sm">
                        ...
                        <div class="pd-x-15 pd-y-20 rounded-its-10 hover-its-1">
                          <div class="media d-flex align-items-center">
                            ...
                            <div class="media-body crop-text-1">
                              ...
                              <p class="tx-13 tx-color-03 mg-b-0 crop-text-1" title="Sistem informasi akademik untuk memantau IPK">Sistem informasi akademik untuk memantau IPK</p>
                            </div>
                          </div>
                        </div>
                      </a>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-b-10 mg-md-b-20">
              <div class="card bd-0">
                <div class="card-header bd-0 pd-md-y-20 d-flex justify-content-start align-items-center">
                  <img src="../../assets/img/calendar-1.svg" class="wd-20 mg-r-15">
                ...
                <div class="card-body bd-0 pd-t-0">
                  <div class="row row-xs">
                    <div class="col-5 col-sm-4 col-md-3 col-lg-6 col-xl-5">
                      <div class="pd-x-15 pd-y-35 rounded-its-10 text-center shadow mg-b-5" style="background-color: #26B4FF; background-image: linear-gradient(to bottom right, #26B4FF, #108EE8);">
                        <h4 class="tx-poppins tx-white mg-b-0">Senin</h4>
                        <h1 class="tx-poppins tx-white tx-76 mg-b-0">31</h1>
                        <p class="tx-poppins tx-medium tx-16 tx-white mg-b-0">Januari</p>
                      ...
                      <div id="carouselExample2" class="carousel slide pd-l-5" data-ride="carousel">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <span class="badge badge-orange-transparent tx-12 mg-b-5">Kategori 1</span>
                            <p class="tx-poppins tx-medium mg-b-5 crop-text-3">Contoh judul acara yang akan muncul di sini</p>
                            <p class="tx-13 tx-medium tx-color-03 mg-b-0"> 00.00 - 00.00 </p>
                            <p class="tx-13 tx-color-03 mg-b-0 crop-text-1" title="Institut Teknologi Sepuluh Nopember"> Institut Teknologi Sepuluh Nopember </p>
                          </div>
                          <div class="carousel-item">
                            <span class="badge badge-info-transparent tx-12 mg-b-5">Kategori 2</span>
                            <p class="tx-poppins tx-medium mg-b-5 crop-text-3">Contoh judul acara yang akan muncul di sini</p>
                            <p class="tx-13 tx-medium tx-color-03 mg-b-0"> 00.00 - 00.00 </p>
                            <p class="tx-13 tx-color-03 mg-b-0 crop-text-1" title="Institut Teknologi Sepuluh Nopember"> Institut Teknologi Sepuluh Nopember </p>
                          </div>
        ...
        <div class="modal-content tabs-animated">
          ...
          <div class="modal-body pd-0">
            <div class="pd-x-15 pd-t-15">
              <div class="form-group form-floating mg-b-10">
                <input type="text" class="form-control" id="search1" name="search" placeholder="Cari..." onkeyup="filter1()">
                <label for="search1">Cari...</label>
              </div>
            </div>
            <div id="scroll1" class="scrollbar-lg ht-450 ht-xl-500 ht-xxl-650 pd-x-5 pd-md-x-15">
              <div class="row row-xs">
