                ...
                <div class="card-body bd-0 pd-t-0">
                  <div class="row row-xs">
                    <div class="col-5 col-sm-5 col-md-5 col-lg-5 col-xl-5">
                      <div class="pd-x-15 pd-y-25 rounded-its-10 text-center shadow" style="background-color: #26B4FF; background-image: linear-gradient(to bottom right, #26B4FF, #108EE8);">
                        <h5 class="tx-poppins tx-white mg-b-0">Senin</h5>
                        <h1 class="tx-poppins tx-white tx-70 mg-b-0">31</h1>
                        <p class="tx-poppins tx-medium tx-15 tx-white mg-b-0">Januari</p>
                        <p class="tx-poppins tx-white mg-b-0">2022</p>
                      </div>
                    </div>
                    <div class="col-7 col-sm-7 col-md-7 col-lg-7 col-xl-7 pos-relative">
                      <div id="carouselExample2" class="carousel slide pd-l-10" data-ride="carousel">
